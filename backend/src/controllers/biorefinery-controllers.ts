...
export const createInfrastructure = async (
    ...
    try {
        ...
        if (existingInfrastructure) return res.status(401).send("This company already has an Infrastructure form registered");
        const today = new Date();
...
export const getAllIndustrialProcesses = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const createIndustrialProcess = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const editIndustrialProcess = async (
  ...
  try {
    ...
    const existingProcess = await IndustrialProcess.findOne({ companyID });
    if (!existingProcess) return res.status(404).send("Industrial process form not found");
...
export const verifyIndustrialProcess = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const getAllDesiredProducts = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const editDesiredProduct = async (
  ...
  try {
    ...
    const existingProduct = await DesiredProduct.findOne({ companyID });
    if (!existingProduct) return res.status(404).send("Desired product form not found");
...
export const verifyDesiredProduct = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
