        ...
        <>
            <DashboardBox gridArea="d">
                <Card sx={{ width: "100%", height: "100%", border: "none" }}>
                    <div>
                        <Typography level="title-lg">Paneles Solares</Typography>
                        <Typography level="body-sm">{solarPanel?.filledFields} de {solarPanel?.totalFields} preguntas respondidas</Typography>
                        <IconButton
                    ...
                    <LinearProgress determinate value={solarPanel?.progress} size="lg" color="success" />
