...
const InfrastructureBox = () => {
    ...
    const handleNavigate = () => {
        navigate('/101-form/BRinfrastructure');
    };
        ...
        <>
            <DashboardBox gridArea="a">
                <Card sx={{ width: "100%", height: "100%", border: "none" }}>
                    <div>
                        <Typography level="title-lg">Infraestructura</Typography>
                        <Typography level="body-sm">{infrastructure?.filledFields} de {infrastructure?.totalFields} preguntas respondidas</Typography>
                        <IconButton
                    ...
                    <LinearProgress determinate value={infrastructure?.progress} size="lg" color="success" />
