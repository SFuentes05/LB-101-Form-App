...
const GradientBackground: React.FC = () => {
  return (
    <div id="bg-wrap" style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
      <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" style={{ width: '100%', height: '100%' }}>
        <defs>
          <radialGradient id="Gradient1" cx="50%" cy="50%" fx="0.441602%" fy="50%" r=".5">
            <animate attributeName="fx" dur="34s" values="0%;3%;0%" repeatCount="indefinite" />
            <stop offset="0%" stopColor="rgba(3, 247, 77, 1)" />
            <stop offset="100%" stopColor="rgba(3, 247, 77, 0)" />
          </radialGradient>
          <radialGradient id="Gradient2" cx="50%" cy="50%" fx="2.68147%" fy="50%" r=".5">
            <animate attributeName="fx" dur="23.5s" values="0%;3%;0%" repeatCount="indefinite" />
            <stop offset="0%" stopColor="rgba(69, 255, 50, 1)" />
            <stop offset="100%" stopColor="rgba(69, 255, 50, 0)" />
          </radialGradient>
          <radialGradient id="Gradient3" cx="50%" cy="50%" fx="0.836536%" fy="50%" r=".5">
            <animate attributeName="fx" dur="21.5s" values="0%;3%;0%" repeatCount="indefinite" />
            <stop offset="0%" stopColor="rgba(28, 219, 255, 1)" />
            <stop offset="100%" stopColor="rgba(28, 219, 255, 0)" />
          </radialGradient>
          ...
          <radialGradient id="Gradient5" cx="50%" cy="50%" fx="2.65405%" fy="50%" r=".5">
            ...
            <stop offset="0%" stopColor="rgba(0, 88, 189, 1)" />
            <stop offset="100%" stopColor="rgba(0, 88, 189, 0)" />
          </radialGradient>
          <radialGradient id="Gradient6" cx="50%" cy="50%" fx="0.981338%" fy="50%" r=".5">
            <animate attributeName="fx" dur="25.5s" values="0%;5%;0%" repeatCount="indefinite" />
            <stop offset="0%" stopColor="rgba(255, 169, 41, 1)" />
            <stop offset="100%" stopColor="rgba(255, 169, 41, 0)" />
          </radialGradient>
        </defs>
